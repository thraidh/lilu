...
Backtracking Rec-Desc Parser with inserted Operator Precedence Parser
...
- generate parser producing CST
    - stateful lexer might not be necessary if already context sensitive
- generate CST visitor
- generate visitor to convert CST into AST
- incremental parsing

## Stage 1

- read simplified grm file
- convert grm file into internal representation
    - rule ::= ID '=' elt* ';'
    - elt ::= ID | STRING

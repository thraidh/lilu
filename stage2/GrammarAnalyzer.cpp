...
class AstNodeToString : public GrammarAstVisitor<string>
{
  public:
    ...
    string visit_AstNode(AstNode *n) override
    {
        return "AstNode";
    }
    ...
    string visit_InnerNode(InnerNode *n) override
    {
        return "InnerNode";
    }
    string visit_KeywordNode(KeywordNode *n) override
    {
        return "KeywordNode";
    }
    string visit_NUMBER_Node(NUMBER_Node *n) override
    {
        return "NUMBER_Node";
    }
    string visit_STRING_Node(STRING_Node *n) override
    {
        return "STRING_Node";
    }
    string visit_alt_Node(alt_Node *n) override
    {
        return "alt_Node";
    }
    ...
    string visit_named_Node(named_Node *n) override
    {
        return "named_Node";
    }
    ...
    string visit_ref_Node(ref_Node *n) override
    {
        return "ref_Node";
    }
    string visit_rep_Node(rep_Node *n) override
    {
        return "rep_Node";
    }
    string visit_rule_Node(rule_Node *n) override
    {
        return "rule_Node";
    }
    string visit_seq_Node(seq_Node *n) override
    {
        return "seq_Node";
    }
    ...
    string visit_text_Node(text_Node *n) override
    {
        return "text_Node";
    }
    string visit_top_Node(top_Node *n) override
    {
        return "top_Node";
    }
};
